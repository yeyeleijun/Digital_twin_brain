...
class TestBlock(unittest.TestCase):
    ...
    def _test_make_whole_brain_include_cortical_laminar_and_subcortical_voxel_model(self,
        ...
        conn_prob, block_size, degree_scale = self._add_laminar_cortex_include_subcortical_in_whole_brain(conn_prob,
                                                                                                          ...
                                                                                                          divide_point)
        # for 100 degree
        gui_laminar = np.array([[0.00994619, 0.00093751, 0.1019024, 0.00458985],
                                ...
                                [0.021273222, 0.00202573, 0.14674303, 0.00587307]], dtype=np.float64)
        gui_voxel = np.array([0.00743193, 0.00086915, 0.07027743, 0.00253291], dtype=np.float64)
