...
parser.add_argument("--print_info", type=str2bool, default=False)
parser.add_argument("--vmean_option", type=str2bool, default=False)
parser.add_argument("--sample_option", type=str2bool, default=False)
parser.add_argument("--imean_option", type=str2bool, default=False)
...
parser.add_argument("--dbs_option", type=str2bool, default=False)
...
# stimulation_voxel(step=args.step, observation_time=args.observation_time, hp_path=args.hp_path, hp_index=hp_index, whole_brain_info=args.whole_brain_info, dbs_option=args.dbs_option)
